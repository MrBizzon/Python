        ...
        if candies[0] == (maximum_stroke and candies[0] > 1):
            ...
            if motion > candies[1]:
                if candies[0] == 1 or candies[0] == 21:
                    print(
                        f'[{player_three}]: Можно взять не более {candies[1]} конфет, на кону {candies[0]} конфета')
                elif 2 <= candies[0] < 5:
                    print(
                        f'[{player_three}]: Можно взять не более {candies[1]} конфет, на кону {candies[0]} конфеты')
                else:
                    print(
                        f'[{player_three}]: Можно взять не более {candies[1]} конфет, на кону {candies[0]} конфет')
                mistake = 2
                while mistake > 0:
